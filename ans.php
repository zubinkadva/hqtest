<?php
	...
	$target_path = $target_path . 'image.png';
...
// ------------------- ATTEMPT 1: GOOGLE QUESTION -------------------
    ...
    for ($i = 0; $i < $node_count; $i++) {
        ...
        curl_setopt($curl_arr[$i], CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.2 (KHTML, like Gecko) Chrome/22.0.1216.0 Safari/537.2');
